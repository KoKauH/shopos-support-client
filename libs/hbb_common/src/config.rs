...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("ShopOS-Support".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["help.shopos.kz"];
pub const RS_PUB_KEY: &str = "f93UmeKCq2sdWp1eg614xlnrWVAJAaao0UqpakgX7cE=";
